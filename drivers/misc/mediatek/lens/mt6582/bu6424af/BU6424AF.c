...
static struct i2c_board_info __initdata kd_lens_dev={ I2C_BOARD_INFO("BU6424AF", 0x20)};
...
static struct i2c_client * g_pstBU6424AF_I2Cclient = NULL;

static dev_t g_BU6424AF_devno;
static struct cdev * g_pBU6424AF_CharDrv = NULL;
static struct class *actuator_class = NULL;

static int  g_s4BU6424AF_Opened = 0;
static long g_i4MotorStatus = 0;
static long g_i4Dir = 0;
static unsigned long g_u4BU6424AF_INF = 0;
...
static int s4BU6424AF_WriteReg(u16 a_u2Data)
{
    ...
    //BU6424AFDB("[BU6424AF] g_sr %d, write %d \n", g_sr, a_u2Data);
...
inline static int getBU6424AFInfo(__user stBU6424AF_MotorInfo * pstMotorInfo)
{
	...
	if (g_s4BU6424AF_Opened >= 1)	{stMotorInfo.bIsMotorOpen = 1;}
...
#if 0
char puSendCmd[2]={(char)(0xA8),(char)(0x4D)};//���Դ���
    if (i4RetValue < 0) 
    {
        BU6424AFDB("[BU6424AF] I2C send failed!! \n");
        return -1;
...
char puSendCmd4[2]={(char)(0x8C),(char)(0x5B)};//115Hz,Fastest mode
...
static int BU6424AF_i2c_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
    ...
    g_pstBU6424AF_I2Cclient->addr =(BU6424AF_VCM_WRITE_ID>> 1);
